...
class LEDHelper:
	def __init__(self, config: ConfigWrapper, update_func, led_count=1):
...
def load_config(config: ConfigWrapper) -> PrinterLED:
	return PrinterLED(config)


def load_config_prefix(config: ConfigWrapper) -> PrinterPWMLED:
